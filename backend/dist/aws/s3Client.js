...
const usePathStyle = typeof conn.forcePathStyle === "boolean" ? conn.forcePathStyle : Boolean(avatarS3Endpoint);
const accessKeyId = trimmedOrEmpty(conn.credentials?.accessKeyId) || (avatarS3Endpoint ? "test" : undefined);
const secretAccessKey = trimmedOrEmpty(conn.credentials?.secretAccessKey) || (avatarS3Endpoint ? "test" : undefined);
