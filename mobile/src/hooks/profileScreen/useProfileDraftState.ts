...
import { profileInitials, profileStatsFromRedux, profileSupportRows } from "./profileMeta";

type Redux = ReturnType<typeof useProfileRedux>;

export function useProfileDraftState(r: Redux) {
