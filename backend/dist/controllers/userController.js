...
function buildRecentStreakDays(dateKeys, today = new Date()) {
...
export async function getAvatarPresignedUrl(req, res) {
    const parsed = z
        .object({
...
export async function patchAvatar(req, res) {
...
export async function postPracticeLog(req, res) {
...
export async function getDailyGoalStatus(req, res) {
...
export async function postDailyGoalStatusMarkNotified(req, res) {
    const dateKey = String(req.params.dateKey);
